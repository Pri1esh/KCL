  ...
  return (
    <footer>
      <div className="container py-4">
          ...
          <div className="col-md-4 subscribe_div">
            ...
            <form noValidate onSubmit={handleSubmit(onSubmit)}>
              <div className="form-group">
                <input type="email" className={`form-control ${errors.email ? "is-invalid" : ""}`} id="subscribeInput" {...register("email")} placeholder="Enter your email ID" />
                {errors.email && <div className="invalid-feedback">{errors.email?.message}</div>}
                {!errors.email && <button type="submit">SIGN UP</button>}
              </div>
            </form>
            ...
            <ul className="social-container">
              <li className="social-logo">
                <a href="">
                  <img className="" src={social1} alt="" />
                </a>
              </li>
              <li className="social-logo">
                <a href="">
                  <img className="" src={social2} alt="" />
                </a>
              </li>
              <li className="social-logo">
                <a href="">
                  <img className="" src={social3} alt="" />
                </a>
              </li>
              <li className="social-logo">
                <a href="">
                  <img className="" src={social4} alt="" />
                </a>
              </li>
              <li className="social-logo">
                <a href="">
                  <img className="" src={social5} alt="" />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="container sbsAlertBox position-relative">
          <div className="alert subscribe-alert alert-light d-flex align-items-center" role="alert">
            <img className="me-4" src={greenTick} alt="" />
            <div>You have been successfully subscribed!</div>
          </div>
        </div>
      </div>
